...
@section('content')
    ...
    <div class="box">
        <div class="panel panel-default">
            <div class="panel-heading font-header">Ordenes Pendientes</div>
            <div class="panel-body">
                @if (session('status'))
                    <div class="alert alert-info fade in col-sm-12 col-md-12 col-lg-12">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                ...
                <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                    ...
                    <table data-order='[[ 0, "asc" ]]' id="orders_pending" class="table table-striped font-12 dataTable no-footer" role="grid" aria-describedby="datatable_info">
                        <thead>
                        <tr>
                            <th>Título</th>
                            <th>#Orden</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#orders_pending').DataTable({
                ...
                deferRender: true,
                pagingType: "full_numbers",
                ajax: '{{route('admin.orders.list.pending')}}',
                columns: [
                    { data: 'nombre_producto', name: 'nombre_producto', orderable: true, searchable: true },
                    { data: 'numero_orden', name: 'numero_orden', orderable: true, searchable: true },
                    { data: 'precio_unidad', name: 'precio_unidad', orderable: true, searchable: true },
